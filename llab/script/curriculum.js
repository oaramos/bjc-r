...
llab.addFooter = function() {
     var footer = '<div class="footer" style="position:relative;"><a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank"><img class="imageLeft" alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a><div style="position:absolute;left: 135px; margin-bottom: 20px;"><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title"><em>Beauty and Joy of Computing</em></span> por <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">University of California, Berkeley and Education Development Center, Inc.</span> está licenciado bajo una licencia internacional <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>. Este material está basado en el trabajo financiado por la National Science Foundation bajo el Grant No. 1441075. Cualquier opinión, descubrimiento o conclusión o recomendación expresada en este material es responsabilidad del autor(es) y no necesariamente refleja el punto de vista de la National Science Foundation.</div></div>';
